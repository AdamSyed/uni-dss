...
# Database
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://admin:msci436project@uni-dss.cmuqyhsxn149.us-east-2.rds.amazonaws.com:3306/uni_dss'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False # To prevent any complaints in console
